defmodule PentoWeb.ProductLiveTest do
  ...
  describe "Index" do
    ...
    test "saves new product", %{conn: conn} do
      ...
      assert index_live |> element("a", "New Product") |> render_click() =~ "New Product"
      ...
      {:ok, _, html} =
        index_live
        |> form("#product-form", product: @create_attrs |> Map.put(:sku, 44))
        |> render_submit()
    ...
    test "updates product in listing", %{conn: conn, product: product} do
      ...
      assert index_live |> element("#product-#{product.id} a", "Edit") |> render_click() =~ "Edit Product"
  ...
  describe "Show" do
    ...
    test "updates product within modal", %{conn: conn, product: product} do
      ...
      assert show_live |> element("a", "Edit") |> render_click() =~ "Edit Product"
